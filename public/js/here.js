...
var map = new H.Map(
        ...
        {
            zoom: 13,
            center: {lat: '-6.82424', lng: '110.83513'},
...
if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        document.getElementById('lat').value = objLocalCoord.lat;
        document.getElementById('lng').value = objLocalCoord.lng;
        ...
        /////////////////// SET CENTER TO MAP ////////////////////////
        map.setCenter({lat:objLocalCoord.lat, lng:objLocalCoord.lng});
        map.setZoom(13);
        /////////////////// SET CENTER TO MAP ////////////////////////
